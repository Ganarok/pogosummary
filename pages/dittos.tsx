...
const Dittos: React.FC = () => {
    ...
    useEffect(() => {
        const fetchPokemons = async () => {
            ...
            try {
                const response = await fetch("https://pogoapi.net/api/v1/possible_ditto_pokemon.json")
    ...
    return (
        <Layout className="flex-col">
            ...
            <div className="flex items-center relative justify-center text-center p-4">
                Pokémons that can be Ditto
            </div>
